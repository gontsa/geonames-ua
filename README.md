...
PDF файли конвертувались у CSV за допомогою [Tabula](https://tabula.technology/).
Дані за 2018 рік, оцифровані з pdf але потребують уточнення та вдосконалення. Зараз вони «як є» з виправленням перевернутих координат чи незначних помилок. Загалом дані __дуже не точні__ але завдяки їм можливо створити відкриту базу геопросторових назв України.

За можливості, надсилайте виправлені некоректно розташовані точки.
