...
За можливості, надсилайте виправлені некоректно розташовані точки (координати) у GeoJSON через [Pull requests](https://github.com/gontsa/geonames-ua/pulls), таким зможемо актуалізувати базу геопросторових даних.
