...
Зараз вони «як є» з виправленням перевернутих координат та незначних помилок. Загалом дані __дуже не точні__ географічно, можливо через «округлення», але завдяки їм можливо створити відкриту базу геопросторових назв України. За відкритість, дякуємо державній службі.
